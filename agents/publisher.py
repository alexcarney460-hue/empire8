...
Wraps the ig-post.py script for the Triple OG Gloves account.
"""
...
def run(reel_info: dict, caption: str) -> dict:
    ...
    try:
        ...
        if post_result["ok"]:
            print("  [PUBLISHER] Posted successfully!")
        else:
            print("  [PUBLISHER] Post may have failed -- check Instagram manually")
