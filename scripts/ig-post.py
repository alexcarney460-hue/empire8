#!/usr/bin/env python3
"""
Instagram poster for Triple OG Gloves — posts images/videos via Playwright browser automation.
...
Uses a separate browser profile (~/.ig_tripleog_browser) so it won't
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Instagram poster for Triple OG Gloves")
